...
Contributions are welcome — see [CONTRIBUTING.md](./CONTRIBUTING.md) for the full workflow, and [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md) for community expectations. For bugs and ideas, please open an [issue](https://github.com/allonsy-studio/stylelint-header/issues/new).
